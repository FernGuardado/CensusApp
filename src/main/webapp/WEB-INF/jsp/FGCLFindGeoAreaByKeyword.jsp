...
<html>
<head>
    <title>FGCLCensusApp - Search Keyword</title>
    <style>
        table, th, td {
...
<section id="search" class="section">
    <div class="container">
        <h2 class="levelTitle">Search By Keyword</h2>
        <p style="color: red">${errorKey}</p>
        <form action="/resultsKeyword" method="GET">
            <input path="search" name="keyword" value="">
